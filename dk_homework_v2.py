...
def goto(dNorth, dEast, beforeLocation):
    """
...
for key_position, value_position in dict_position.items():
    ...
    before_target_location = goto(value_position['North'], value_position['East'], before_target_location)
